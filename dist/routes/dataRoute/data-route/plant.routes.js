...
plantRouter.get('/plants', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
plantRouter.get('/plants/:_id', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { _id } = req.params; // Get the _id parameter from the URL
        const response = yield axios_1.default.get(`${plantUrls_1.data_plants_url}/${_id}`);
